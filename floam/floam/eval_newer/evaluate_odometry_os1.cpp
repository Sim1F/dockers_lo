...
// int training_set_minmax[] = {0,2}; // without parkland
int training_set_minmax[] = {0,3}; // with parkland
// int testing_set_minmax[] = {11,22};

bool eval (string abs_path_to_data) {

  // ground truth and result directories
  // abs_path_to_data = "/media/simone/PortableSSD/datasets/os1_newer_college";
  ...
  // /media/simone/PortableSSD/datasets/os1_newer_college

  // /media/simone/PortableSSD/datasets/os1_newer_college/floam/01_short_experiment/01_short_experiment_poses_kitti.txt

  // /media/simone/PortableSSD/datasets/os1_newer_college/01_short_experiment/gt_kitti.txt
  ...
  for (int32_t i=training_set_minmax[0]; i<training_set_minmax[1]; i++) {
    ...
    switch (i) {
      case 0:
        folder_name_str = "01_short_experiment";
        break;
      case 1:
        folder_name_str = "02_long_experiment";
        break;
      case 2:
        folder_name_str = "07_parkland_mound";
        break;
      default:
        folder_name_str = "";
        break;
