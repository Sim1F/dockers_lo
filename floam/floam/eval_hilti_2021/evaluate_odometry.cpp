...
int training_set_minmax[] = {0,2}; // without stairs
...
bool eval (string abs_path_to_data) {
  ...
  // /media/simone/PortableSSD/datasets/hilti_2021

  // /media/simone/PortableSSD/datasets/hilti_2021/floam/drone/drone_poses_kitti.txt

  // /media/simone/PortableSSD/datasets/hilti_2021/drone/gt_kitti.txt
