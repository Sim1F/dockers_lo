...
# rosbag_folder_path=/home/os0_newer_college/catacombs_easy/os
# pcd_folder_path=/home/os0_newer_college/catacombs_easy/pcd
rosbag_folder_path=/media/simone/PortableSSD/datasets/os0_newer_college/catacombs_easy/os
pcd_folder_path=/media/simone/PortableSSD/datasets/os0_newer_college/catacombs_easy/pcd
for rosbag in ${rosbag_folder_path}/*bag
do 
	# rosrun pcl_ros bag_to_pcd ${rosbag} sensor_msgs/PointCloud2 ${pcd_folder_path}
	rosrun pcl_ros bag_to_pcd ${rosbag} /os_cloud_node/points ${pcd_folder_path}
done
